...
window.addEventListener("load", (event) => {
  ...
  ​
  // let languages = [];
  // function getObjectKeyPairs(obj) {
  //   for (const lang in obj) {
  //     let language = {
  //       language_id: lang,
  //       language_name: obj[lang],
  //     };
  ...
  //to do - look for token, if token is not found it should reroute you to the login page - done
  //Gavin continued
  //to do - server fetch the files
  let userWords;
